...
![1.00](https://developers.openai.com/images/blog/designing-beautiful-frontends.png "Создание потрясающих интерфейсов с помощью GPT-5.4")
...
![1.00](https://cdn.openai.com/devhub/blog/codex_moodboard.png "Пример мудборда, который помог GPT-5.4 выбрать единое визуальное направление")
